    ...
    return (
        <div className="navMenu">
            ...
            <div className="secondMenu menu">
                <p> 프론트엔드 </p>
                <button className="col_b_r" onClick={() => { send("html") }}> <img src={process.env.PUBLIC_URL + '/img/NavMenu/Html_icon.png'} /> HTML </button>
                <button className="col_b_r" onClick={() => { send("css") }}> <img src={process.env.PUBLIC_URL + '/img/NavMenu/Css_icon.svg'} /> CSS </button>
