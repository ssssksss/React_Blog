        ...
        <>
            ...
            <div className="common_style" ref={(elem) => (blockRef.current[1] = elem)} >
                <span className="lblock">
                    ...
                    <span className="mblock">
                        <details>
                            <summary className="stitle"> ▶ media-queries(미디어 쿼리) <a name="media-queries(미디어 쿼리)" style={{ visibility: "hidden" }}> media-queries(미디어 쿼리) </a> </summary>
                            <span className="sblock">
                    ...
                    <span className="mblock">
                        <details>
                            <summary className="stitle"> ▶ text-align(글자위치조정) <a name="text-align(글자위치조정)" style={{ visibility: "hidden" }}> text-align(글자위치조정) </a> </summary>
                            <span className="sblock">
                                <span className="sstitle">  </span>
                                <span className="mblock">
                    ...
                    <span className="mblock">
                        <details>
                            <summary className="stitle"> ▶ font(폰트) <a name="font(폰트)" style={{ visibility: "hidden" }}> font(폰트) </a> </summary>
                            <span className="sblock">
                    ...
                    <span className="mblock">
                        <details>
                            <summary className="stitle"> ▶ box-shadow(그림자) <a name="box-shadow(그림자)" style={{ visibility: "hidden" }}> box-shadow(그림자) </a> </summary>
                            <span className="sblock">
                                <span className="sstitle">  </span>
                                <span className="mblock">
                                    <li>  </li>
                    ...
                    <span className="mblock">
                        <details>
                            <summary className="stitle"> ▶ @support <a name="@support" style={{ visibility: "hidden" }}> @support </a> </summary>
                            <span className="sblock">
                                <span className="sstitle">  </span>
                    ...
                    <span className="mblock">
                        <details>
                            <summary className="stitle"> ▶ snap-scroll <a name="snap-scroll" style={{ visibility: "hidden" }}> snap-scroll </a> </summary>
                            <span className="sblock">
                    ...
                    <span className="mblock">
                        <details>
                            <summary className="stitle"> ▶ aspect-ratio(화면 비율 조정) <a name="aspect-ratio(화면 비율 조정)" style={{ visibility: "hidden" }}> aspect-ratio(화면 비율 조정) </a> </summary>
                            <span className="sblock">
                    ...
                    <span className="mblock">
                        <details>
                            <summary className="stitle"> ▶ line-height(텍스트행사이의거리) <a name="line-height(텍스트행사이의거리)" style={{ visibility: "hidden" }}> line-height(텍스트행사이의거리) </a> </summary>
                            <span className="sblock">
                    ...
                    <span className="mblock">
                        <details>
                            <summary className="stitle"> ▶ list-style(목록태그설정) <a name="list-style(목록태그설정)" style={{ visibility: "hidden" }}> list-style(목록태그설정) </a> </summary>
                            <span className="sblock">
                                <span className="sstitle">  </span>
                    ...
                    <span className="mblock">
                        <details>
                            <summary className="stitle"> ▶ text-align(가로정렬) <a name="text-align(가로정렬)" style={{ visibility: "hidden" }}> text-align(가로정렬) </a> </summary>
                            <span className="sblock">
                                <span className="sstitle">  </span>
                                <span className="mblock">
                    ...
                    <span className="mblock">
                        <details>
                            <summary className="stitle"> ▶ letter-spacing(글자사이간격조정) <a name="letter-spacing(글자사이간격조정)" style={{ visibility: "hidden" }}> letter-spacing(글자사이간격조정) </a> </summary>
                            <span className="sblock">
                    ...
                    <span className="mblock">
                        <details>
                            <summary className="stitle"> ▶ white-space(공백문자처리) <a name="white-space(공백문자처리)" style={{ visibility: "hidden" }}> white-space(공백문자처리) </a> </summary>
                            <span className="sblock">
                                <span className="sstitle">  </span>
                                <span className="mblock">
                    ...
                    <span className="mblock">
                        <details>
                            <summary className="stitle"> ▶ word-break(단어분리처리여부) <a name="word-break(단어분리처리여부)" style={{ visibility: "hidden" }}> word-break(단어분리처리여부) </a> </summary>
                            <span className="sblock">
                    ...
                    <span className="mblock">
                        <details>
                            <summary className="stitle"> ▶ word-wrap(요소를넘은글자처리여부) <a name="word-wrap(요소를넘은글자처리여부)" style={{ visibility: "hidden" }}> word-wrap(요소를넘은글자처리여부) </a> </summary>
                            <span className="sblock">
                                <span className="sstitle">  </span>
                                <span className="mblock">
                    ...
                    <span className="mblock">
                        <details>
                            <summary className="stitle"> ▶ display(요소디스플레이속성) <a name="display(요소디스플레이속성)" style={{ visibility: "hidden" }}> display(요소디스플레이속성) </a> </summary>
                            <span className="sblock">
                    ...
                    <span className="mblock">
                        <details>
                            <summary className="stitle"> ▶ transform(회전,크기,기울기,이동) <a name="transform(회전,크기,기울기,이동)" style={{ visibility: "hidden" }}> transform(회전,크기,기울기,이동) </a> </summary>
                            <span className="sblock">
                    ...
                    <span className="mblock">
                        <details>
                            <summary className="stitle"> ▶ flex(이어서?배치) <a name="flex(이어서?배치)" style={{ visibility: "hidden" }}> flex(이어서?배치) </a> </summary>
                            <span className="sblock">
                                <span className="sstitle">  </span>
                                <span className="mblock">
                                    <li> display: flex; </li>
                    ...
                    <span className="mblock">
                        <details>
                            <summary className="stitle"> ▶ flex-direction(플렉스요소배치) <a name="flex-direction(플렉스요소배치)" style={{ visibility: "hidden" }}> flex-direction(플렉스요소배치) </a> </summary>
                            <span className="sblock">
                    ...
                    <span className="mblock">
                        <details>
                            <summary className="stitle"> ▶ filter(필터효과) <a name="filter(필터효과)" style={{ visibility: "hidden" }}> filter(필터효과) </a> </summary>
                            <span className="sblock">
                                <span className="sstitle">  </span>
                                <span className="mblock">
                    ...
                    <span className="mblock">
                        <details>
                            <summary className="stitle"> ▶ variable(변수) <a name="variable(변수)" style={{ visibility: "hidden" }}> variable(변수) </a> </summary>
                            <span className="sblock">
