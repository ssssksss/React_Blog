          ...
          <div className="hyperlink">
            <details open>
              ...
              <details open>
                ...
                <a href="#DNS" className="col_p"> DNS </a>
                <a href="#SSH" className="col_p"> SSH </a>
                <a href="#Rlogin" className="col_p"> Rlogin </a>
                <a href="#Telnet" className="col_p"> Telnet </a>
                <a href="#FTP" className="col_p"> FTP </a>
