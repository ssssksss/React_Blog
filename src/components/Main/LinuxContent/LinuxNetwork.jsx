...
const LinuxNetwork = (props) => {
  ...
  return (
    <div className="common_style">
      ...
      <div className='block1'>
        <details>
          ...
          <div className='block2'>
            ...
            <h2 className='h2'> 📌 방화벽 허용 및 재시작 </h2>
            <div className="block4">
      ...
      <div className='block1'>
        <details>
          <summary> iptables - <small> # 포트포워딩 설정 </small> </summary>
          <div className='block2'>
            ...
            <li> iptables -I INPUT -p tcp -s 0.0.0.0/0 -d [IP주소] --dport [포트] ACCEPT <small> # 모든곳에서 IP주소:포트로 오는 패킷 허용  </small> </li>
