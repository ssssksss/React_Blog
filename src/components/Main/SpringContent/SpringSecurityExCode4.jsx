                                    ...
                                    <details open>
                                        ...
                                        <details open>
                                            ...
                                            <details open>
                                                ...
                                                <a href="#CustomOAuth2UserService" className="col_p"> CustomOAuth2UserService </a>
                                                ...
                                                <a href="#FacebookUserInfo" className="col_p"> FacebookUserInfo </a>
                                                <a href="#GoogleUserInfo" className="col_p"> GoogleUserInfo </a>
                                                <a href="#NaverUserInfo" className="col_p"> NaverUserInfo </a>
                                                <a href="#OAuth2UserInfo" className="col_p"> OAuth2UserInfo </a>
                                            </details>
                                            <details open>
