            ...
            <div className='block1'>
                <details>
                    ...
                    <div className='block2'>
                        ...
                        <h2 className='h2'> 📌 유저에게 접근 권한 주기 </h2>
                        <li> grant select on 데이터베이스.테이블 to '사용자'@'[localhost IP %]' <small> # select 권한주기 </small> </li>

                        <h2 className='h2'> 📌 유저의 접근 권한 삭제하기 </h2>
                        <li> revoke all on 데이터베이스.테이블 to '사용자'@'[localhost IP %]' </li>
                    ...
                    <details>
                        ...
                        <div className='sblock'>
                            ...
                            <div className='mblock'>
                                ...
                                <li> SELECT database(); <small> # 현재 DB 확인 </small> </li>
                                ...
                                <li> USE mysql; <small> # 사용하려는 DB로 변경 </small>
