...
const SpringJpa = (props) => {
    ...
    return (
        <div className="common_style">
            ...
            <div className='block1'>
                <details>
                    <summary> JPA문법(정리해야할 공간) </summary>
                    <div className='block2'>
                        <h2 className='h2'> 📌 Create </h2>
                        <li>  </li>
                        <li> </li>
                        <h2 className='h2'> 📌 Read </h2>
                        <li> 1개의 조건을 만족하는 필드 조회 : <span className='command'> 엔티티객체 findByFieldname(String fieldname) </span> </li>
                        <li> 2개의 조건을 만족하는 필드 조회 :  <span className='command'> findByFieldname1AndFieldname2(String fieldname1, String fieldname2) </span> </li>
                        <li> 2개중 1개의 조건을 만족하는 필드 조회 :  <span className='command'> findByFieldname1OrFieldname2(String fieldname1, String fieldname2) </span> </li>
                        <li> 모든 필드 조회 :  <span className='command'> {" List<엔티티객체> findAll() "} </span> </li>
                        <li>  <span className='command'> findDistinctByFieldname1  </span> </li>
                        <li> 객체가 없어도 에러 발생하지 않음 <span className='command'> {"  Optional<User> findByEmail(String email); "} </span> </li>
                        <li> 값을 조회해서 불린값으로 리턴 <span className='command'> Boolean existsByEmail(String email); </span> </li>
                        <li>  </li>
